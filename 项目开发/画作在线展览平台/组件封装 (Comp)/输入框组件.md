输入框组件 `FormInputComp.vue` 是对原生元素 input 的二次封装，显示效果如下：

不带 Label：
![[Pasted image 20230621144442.png]] 
![[Pasted image 20230621144513.png]]

带 Label：
![[Pasted image 20230621144536.png]]
![[Pasted image 20230621144554.png]]

---

## 组件模板

`FormInputComp.vue - template`
```html
<template>
    <div class="form-input-wrap" :class="`form-input-style--${theme}`">
        ...
        <div class="form-input-main" :data-is-focus="focused">
            ...
            <i
	            v-if="iconfont"
	            class="form-input-icon iconfont"
	            :class="iconfont"
	        ></i>
            <!-- 输入框前置文字 -->
            <span
